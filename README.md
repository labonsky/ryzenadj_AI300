...
**Current release: [v0.20.2](https://github.com/labonsky/ryzenadj_AI300/releases/tag/v0.20.2)** - RPM for Fedora (kernel 6.18+)
...
```bash
# Install
sudo dnf install ryzenadj-ryzen_smu-ai300-krackan-PP-0.20.2-1.fc43.x86_64.rpm
